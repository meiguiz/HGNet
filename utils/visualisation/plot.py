...
def save_results(idx, rgb_img, grasp_q_img, grasp_angle_img, depth_img=None, no_grasps=1, grasp_width_img=None):
    """
    Plot the output of a network
    :param rgb_img: RGB Image
    :param depth_img: Depth Image
    ...
    ax.set_title('RGB')
    ax.axis('off')
    fig.savefig('results/rgb{}.png'.format(idx))
    ...
    if depth_img.any():
        ...
        ax.set_title('Depth')
        ax.axis('off')
        fig.savefig('results/depth{}.png'.format(idx))
    ...
    ax.set_title('Grasp')
    ax.axis('off')
    fig.savefig('results/grasp{}.png'.format(idx))
    ...
    ax.axis('off')
    plt.colorbar(plot)
    fig.savefig('results/quality{}.png'.format(idx))
    ...
    ax.axis('off')
    plt.colorbar(plot)
    fig.savefig('results/angle{}.png'.format(idx))
    ...
    ax.axis('off')
    plt.colorbar(plot)
    fig.savefig('results/width{}.png'.format(idx))
